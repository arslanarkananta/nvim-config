...
-- see https://github.com/vim/vim/issues/4379
...
vim.api.nvim_create_autocmd("TextYankPost", {
    callback = function()
        vim.highlight.on_yank({ higroup="YankColor", timeout=199 })
    end,
})
...
-- line before executing this command, see https://vi.stackexchange.com/a/20397/15292 .
...
api.nvim_create_autocmd({ "VimEnter", "DirChanged" }, {
  ...
  callback = function()
    require("utils").inside_git_repo()
  end,
})

-- See https://vi.stackexchange.com/a/169/15292
